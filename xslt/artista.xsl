...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="getBio">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$id='bmth'">Bring Me The Horizon es una banda británica originaria de Sheffield, conocida por su evolución constante desde el deathcore hasta el rock alternativo y electrónico. Fundada en 2004, se hizo famosa con álbumes como Count Your Blessings y Sempiternal, caracterizados por riffs pesados y voces agresivas, mientras que trabajos posteriores como amo y Post Human: Survival Horror muestran un enfoque más experimental y melódico. La banda ha destacado por combinar elementos de metal, electrónica y pop, y sus letras abordan temas como ansiedad, relaciones, política y crítica social. Con una presencia escénica enérgica y una constante reinvención de su sonido, Bring Me The Horizon ha logrado atraer a un público diverso y mantener relevancia en la escena del rock moderno, consolidándose como uno de los grupos británicos más influyentes de su generación.</xsl:when>
            <xsl:when test="$id='babymetal'">BABYMETAL es un grupo japonés que fusiona metal con J-pop, formado en 2010. Compuesto originalmente por tres integrantes jóvenes, se caracteriza por combinaciones de riffs pesados, coros pop y coreografías sincronizadas, creando un estilo único conocido como “kawaii metalâ€. Álbumes como BABYMETAL y Metal Galaxy han consolidado su popularidad global, llevando su propuesta a escenarios internacionales y festivales de metal. La banda ha desafiado convenciones del género al combinar idol japonés con metal extremo, atrayendo tanto a fans del pop como del rock pesado. Su estética, energía en vivo y originalidad les han permitido ganar reconocimiento mundial, influir en nuevas generaciones de artistas y convertirse en un fenómeno de la música japonesa contemporánea.</xsl:when>
            <xsl:when test="$id='yungblud'">YUNGBLUD, nombre artístico de Dominic Harrison, es un cantante y compositor británico que mezcla punk, rock alternativo y pop. Su música se centra en la juventud, la rebeldía y la crítica social, abordando temas como identidad, salud mental y política, lo que lo ha convertido en un referente generacional. Desde sus primeros sencillos hasta álbumes como 21st Century Liability y Weird!, YUNGBLUD combina energía punk con melodías pegajosas y letras comprometidas. Además de su música, es conocido por su estilo extravagante, actuaciones enérgicas y conexión cercana con sus fans. Su capacidad para abordar temas relevantes de manera directa y emocional le ha permitido destacarse en la escena internacional, convirtiéndose en una figura influyente dentro del rock contemporáneo y la cultura juvenil.</xsl:when>
            <xsl:when test="$id='limpbizkit'">Limp Bizkit es una banda estadounidense de nu metal formada en 1994 en Jacksonville, Florida. Su estilo combina rap, rock y metal, caracterizado por riffs pesados, vocales agresivas y ritmos de hip hop. Alcanzaron fama mundial con álbumes como Significant Other (1999) y Chocolate Starfish and the Hotdog Flavored Water (2000), impulsados por sencillos como “Nookieâ€ y “Break Stuffâ€. La banda se destacó en la escena del nu metal durante finales de los 90 y principios de los 2000, y su imagen rebelde, junto con sus espectáculos energéticos, los convirtió en un referente de la cultura juvenil de la época. A lo largo de su carrera, han enfrentado altibajos, pero siguen manteniendo una base de fans sólida, y sus canciones continúan siendo escuchadas en plataformas digitales, consolidando su legado en la historia del rock alternativo.</xsl:when>
            <xsl:otherwise>
