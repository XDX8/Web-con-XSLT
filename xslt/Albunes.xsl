...
<div class="nav-box">
  ...
  <ul class="nav-links">
                ...
                <li><a href="../xml/Canciones.xml">Canciones</a></li>
                <li><a href="../xml/Albunes.xml">Albumes</a></li>
        <li><a href="../xml/bd.xml">Artistas</a></li>
  </ul>
</div>
<div class="principal">
                ...
                <img class="cover-photo" alt="Portada del album">
                    <xsl:attribute name="src">
                        <xsl:call-template name="resolveImageSrc">
                            ...
                            <xsl:with-param name="tertiary" select="''"/>
                            <xsl:with-param name="default" select="''"/>
                        </xsl:call-template>
                    </xsl:attribute>
                </img>
                <div>
                    <strong class="truncate-title"><xsl:value-of select="title"/></strong><br/>
                    Artista: <xsl:value-of select="key('artistById', artistId)/grupo"/><br/>
